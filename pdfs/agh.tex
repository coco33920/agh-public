...
\ohead{\headmark}
\setlength{\footheight}{18.00017pt}

\usepackage{calc}
\newcommand\footy{\parbox{\textwidth}{\hrulefill\kern-0.6ex\raisebox{-0.5ex}{$\Bigl[$\makebox[\widthof{1.2{\thepage\text{ of }\pageref{LastPage}}}][c]{\thepage\text{ of }\pageref{LastPage}}$\Bigr]$}\kern-0.5ex\hrulefill}}
\cfoot[\footy]{\footy}
...
%End after the epilogue, the glossary
\printglossaries
\end{document}